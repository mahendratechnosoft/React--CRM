...
import CreateBomCategory from "../../../CompanyComponent/BomCategorieSettings/CreateBomCategory";

//  import "../../../CompanyComponent/ChechlistItemSetting/BomCategory.css"; 
import "../../../CompanyComponent/BomCategorieSettings/BomCategory.css";
...
import UpdateBomCategory from "../../../CompanyComponent/BomCategorieSettings/UpdateBomCategory";

const SettingBomCategories = () => {
  ...
  const handleDelete = async (categoryName) => {
    if (
      ...
      const response = await axiosInstance.delete(
        `/kickoff/deleteBomCategory/${categoryName}`
      );
      if (response.data) {
...
export default SettingBomCategories;
