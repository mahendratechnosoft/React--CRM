...
const CreateBoM = () => {
  ...
  const fetchWorkOrderNumberByItemNo = async (itemNo) => {
    try {
      ...
      const partNameResponse = await axiosInstance.get(
        `/kickoff/getPartNameByItemNo/${itemNo}`
      );
                  ...
                  <div className="row">
                    ...
                    <div className="col-md-6">
                      <Form.Group className="mb-3" controlId="formWorkOrderNo">
                        ...
                        <Form.Select
                          aria-label="Select Work Order Number"
                          required
                          name="workOrderNo"
                    ...
                    <div className="col-md-6">
                      <Form.Group className="mb-3" controlId="formDieDetails">
                        ...
                        <Form.Control
                          ...
                          name="dieDetails"
                          value={dieDetails}
                          onChange={(e) => setDieDetails(e.target.value)}
                        />
                      </Form.Group>
                    </div>
                  </div>
